...
const packages: (PackageData & { tagline: string; popular: boolean; variant: "outline-gold" | "gold"; features: string[] })[] = [
  {
    ...
    popular: false,
    features: [
      "Personalized Consultation (3 sessions)",
      "Customized Roadmap and Guides",
    ...
    whatYouGet: [
      { title: "Personalized Consultation — 3 Sessions", desc: "Discovery & Strategy (60min), Practical Planning (60min), Action Plan (60min)" },
      { title: "Customized Roadmap", desc: "Step-by-step plan, timeline, administrative guidance, priority actions" },
  ...
  },
  {
    ...
    whatYouGet: [
      ...
      { title: "Advanced and Customized Plan", desc: "Detailed roadmap, financial projections, housing recommendations, investment positioning, risk mitigation" },
      { title: "Priority Email & Advisory Support — 60 Days", desc: "Priority responses, ongoing guidance, strategic adjustments" },
      { title: "Partners & Ecosystem Access", desc: "Introductions to local contacts, service providers, business ecosystem, real estate" },
    ],
  ...
  },
  {
    ...
    features: [
      ...
      "Local Ecosystem & Partners Coordination",
      "Post-Move Support",
    ],
    ...
    whatYouGet: [
      ...
      { title: "End-to-End Support", desc: "Housing search guidance, administrative processes, local orientation" },
      { title: "On-Call Assistance", desc: "Direct WhatsApp/phone access, immediate support when needed" },
      { title: "Full Integration Plan", desc: "Detailed roadmap, daily/weekly action guidance, personalized integration strategy" },
      { title: "Local Ecosystem & Partners Coordination", desc: "Introductions to real estate professionals, legal services, business partners" },
      { title: "Post-Move Support", desc: "Settling-in assistance, lifestyle optimization, ongoing advisory after arrival" },
    ],
